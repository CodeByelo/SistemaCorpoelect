...
export const PERMISSIONS_MASTER = {
    ...
    // 5. Chatbot / Asistente Virtual
    CHATBOT_CONFIGURE_LEARNING: 'CHATBOT_CONFIGURE_LEARNING',
};
...
export const PERMISSION_LABELS: Record<string, string> = {
    ...
    CHATBOT_CONFIGURE_LEARNING: 'Configurar modo de aprendizaje del asistente',
};
...
export const DEFAULT_SCOPES: Record<string, string[]> = {
    ...
    Administrativo: [
        ...
        PERMISSIONS_MASTER.CHATBOT_CONFIGURE_LEARNING
    ],
